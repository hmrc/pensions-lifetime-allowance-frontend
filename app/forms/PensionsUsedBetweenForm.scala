...
object PensionsUsedBetweenForm extends CommonBinders {
  ...
  def pensionsUsedBetweenForm = Form (
    mapping(
      "pensionsUsedBetweenAmt" -> optional(bigDecimal)
        .verifying("pla.pensionsUsedBetween.amount.errors.mandatoryError", pensionsUsedBetweenAmt => pensionsUsedBetweenAmt.isDefined)
