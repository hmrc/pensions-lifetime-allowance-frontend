...
enum AmendResponseProtectionType(override val jsonString: String, val toProtectionType: ProtectionType)
    extends JsonEnum {
...
object AmendResponseProtectionType extends JsonEnumFormat[AmendResponseProtectionType] {
