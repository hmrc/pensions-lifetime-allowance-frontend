...
class SummaryController @Inject() (
  ...
  private def routeIP2016SummaryFromUserData(
      data: CacheMap,
      nino: String
    ...
    summaryConstructor.createSummaryData(data).map(summaryModel => Ok(summary(summaryModel))).getOrElse {
