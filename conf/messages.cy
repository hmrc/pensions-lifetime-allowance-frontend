...
psoDetails.error.required                   = Nodwch ddyddiad eich gorchymyn rhannu pensiwn
psoDetails.error.required.day               = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn gynnwys diwrnod
psoDetails.error.required.dayMonth          = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn gynnwys diwrnod a mis
psoDetails.error.required.dayYear           = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn diwrnod a blwyddyn
psoDetails.error.required.month             = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn gynnwys mis
psoDetails.error.required.monthYear         = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn gynnwys mis a blwyddyn
psoDetails.error.required.year              = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn gynnwys blwyddyn
psoDetails.error.invalid                    = Nodwch ddyddiad dilys gan ddefnyddio rhifau
psoDetails.error.invalid.day                = Mae’n rhaid i ddiwrnod eich gorchymyn rhannu pensiwn fod yn rhif
psoDetails.error.invalid.dayMonth           = Mae’n rhaid i ddiwrnod a mis eich gorchymyn rhannu pensiwn fod yn rhif
psoDetails.error.invalid.dayYear            = Mae’n rhaid i ddiwrnod a blwyddyn eich gorchymyn rhannu pensiwn fod yn rhif
psoDetails.error.invalid.month              = Mae’n rhaid i fis eich gorchymyn rhannu pensiwn fod yn rhif
psoDetails.error.invalid.monthYear          = Mae’n rhaid i fis a blwyddyn eich gorchymyn rhannu pensiwn fod yn rhif
psoDetails.error.invalid.year               = Mae’n rhaid i flwyddyn eich gorchymyn rhannu pensiwn fod yn rhif
psoDetails.error.notReal                    = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn fod yn ddyddiad go iawn
psoDetails.error.notReal.day                = Mae’n rhaid i ddiwrnod eich gorchymyn rhannu pensiwn fod yn rhif dilys
psoDetails.error.notReal.month              = Mae’n rhaid i fis eich gorchymyn rhannu pensiwn fod yn rhif dilys
psoDetails.error.notReal.year               = Mae’n rhaid i flwyddyn eich gorchymyn rhannu pensiwn fod yn rhif dilys

psoDetails.error.range.min                  = Ni all dyddiad eich gorchymyn rhannu pensiwn fod yn y dyfodol
psoDetails.error.range.max                  = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn fod ar ôl 5 Ebrill 2016
