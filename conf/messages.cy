...
psoDate.error.required                   = Nodwch ddyddiad eich gorchymyn rhannu pensiwn
psoDate.error.required.day               = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn gynnwys diwrnod
psoDate.error.required.dayMonth          = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn gynnwys diwrnod a mis
psoDate.error.required.dayYear           = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn diwrnod a blwyddyn
psoDate.error.required.month             = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn gynnwys mis
psoDate.error.required.monthYear         = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn gynnwys mis a blwyddyn
psoDate.error.required.year              = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn gynnwys blwyddyn
psoDate.error.invalid                    = Nodwch ddyddiad dilys gan ddefnyddio rhifau
psoDate.error.invalid.day                = Mae’n rhaid i ddiwrnod eich gorchymyn rhannu pensiwn fod yn rhif
psoDate.error.invalid.dayMonth           = Mae’n rhaid i ddiwrnod a mis eich gorchymyn rhannu pensiwn fod yn rhif
psoDate.error.invalid.dayYear            = Mae’n rhaid i ddiwrnod a blwyddyn eich gorchymyn rhannu pensiwn fod yn rhif
psoDate.error.invalid.month              = Mae’n rhaid i fis eich gorchymyn rhannu pensiwn fod yn rhif
psoDate.error.invalid.monthYear          = Mae’n rhaid i fis a blwyddyn eich gorchymyn rhannu pensiwn fod yn rhif
psoDate.error.invalid.year               = Mae’n rhaid i flwyddyn eich gorchymyn rhannu pensiwn fod yn rhif
psoDate.error.notReal                    = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn fod yn ddyddiad go iawn
psoDate.error.notReal.day                = Mae’n rhaid i ddiwrnod eich gorchymyn rhannu pensiwn fod yn rhif dilys
psoDate.error.notReal.month              = Mae’n rhaid i fis eich gorchymyn rhannu pensiwn fod yn rhif dilys
psoDate.error.notReal.year               = Mae’n rhaid i flwyddyn eich gorchymyn rhannu pensiwn fod yn rhif dilys
psoDate.error.range.min                  = Ni all dyddiad eich gorchymyn rhannu pensiwn fod yn y dyfodol
psoDate.error.range.max                  = Mae’n rhaid i ddyddiad eich gorchymyn rhannu pensiwn fod ar ôl 5 Ebrill 2016
