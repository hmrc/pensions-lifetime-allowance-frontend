...
trait AmendIP14PensionsWorthBeforeViewMessages {
  val plaIP14PensionsWorthBeforeTitle =  "What were these pensions worth on 5 April 2014? - Check your pension protections and enhancements - GOV.UK"
  ...
  val plaIP14PensionsWorthBeforeParaTwo = "You'll need to do a different calculation if either of the following apply:"
  val plaIP14PensionsWorthBeforeParaThree = "Find out how in this"
