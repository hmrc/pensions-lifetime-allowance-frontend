...
trait PensionsTakenBeforeViewMessages {
  ...
  val plaPensionsTakenBeforeTitle =
    "Did you get an income from any of your pensions before 6 April 2006? - Check your pension protections - GOV.UK"
  ...
  val plaPensionsTakenBeforeParaThree =
    "Find out how in this technical guidance on valuing your pensions (opens in a new window)"

  val plaPensionsTakenBeforeParaThreeNew =
    "Find out how in this technical guidance on valuing your pensions (opens in new tab)."

  val plaPensionsTakenBeforeStepOne = "Take only the pensions from which you got an income prior to 6 April 2006."

  val plaPensionsTakenBeforeStepTwo =
    "Work out the annual amount you were able to receive from these pensions (the annual rate) on 5 April 2016."
  ...
  val plaPensionsTakenBeforeHelpLinkLocation =
