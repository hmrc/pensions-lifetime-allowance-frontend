...
trait WithdrawImplicationsSpecMessages {
  ...
  def plaWithdrawProtectionTitle(protectionType: String) =
    s"Withdraw from $protectionType - Check your pension protections and enhancements - GOV.UK"
  ...
  def plaWithdrawImplicationInfo(protectionType: String) =
    s"Once you withdraw, you will no longer have $protectionType. This might mean you have to pay a higher rate of tax on your pension."

  def plaWithdrawProtectionIfInfo(protectionType: String) =
    s"Use this service to withdraw from your $protectionType if:"
