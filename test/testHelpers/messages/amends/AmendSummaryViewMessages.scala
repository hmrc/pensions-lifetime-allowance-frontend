...
trait AmendSummaryViewMessages {
  ...
  val plaSummaryUnderThresholdErrorIP2016 =
    "Your total pension savings were less than £1,000,001 on 5 April 2016. You can only apply for individual protection 2016 if your pension savings were £1,000,001 or more."

  val plaSummaryPensionsHeading = "Value of pensions"
  val plaSummaryChange          = "Change"

  val plaSummaryQuestionsPensionsTaken =
    "Before 6 April 2016, did you get money from your pensions, transfer a pension overseas, or turn 75 with money still in a pension?"

  val plaSummaryHiddenLinkTextPensionsTaken =
    "Change your response to the question 'have you taken any of your pensions'"

  val plaSummaryQuestionsPensionsTakenBefore = "Did you get an income from any of your pensions before 6 April 2006?"

  val plaSummaryHiddenLinkTextPensionsTakenBefore =
    "Change your response to the question 'Did you get an income from any of your pensions before 6 April 2006?'"

  val plaSummaryQuestionsPensionsTakenBeforeAmt = "What's the value of the pensions you took before 6 April 2006?"

  val plaSummaryHiddenLinkTextPensionsTakenBeforeAmt =
    "Change your response to the value of the pensions you took before 6 April 2006"

  val plaSummaryQuestionsPensionsTakenBetween =
    "Between 6 April 2006 and 5 April 2016, did you get money from your pensions, transfer a pension overseas, or turn 75 with money still in a pension?"

  val plaSummaryHiddenLinkTextPensionsTakenBetween =
    "Change your response to the question 'did you get money from your pensions between 6 April 2006 and 5 April 2016'"
  ...
  val plaSummaryHiddenLinkTextOverseasPensions =
    "Change your response to the question 'Have you put money into a pension scheme held overseas?'"

  val plaSummaryQuestionsOverseasPensionsAmt = "How much did you contribute?"

  val plaSummaryHiddenLinkTextOverseasPensionsAmt =
    "Change your response to the amount of overseas pensions you put in between 6 April 2006 and 5 April 2016"

  val plaSummaryQuestionsCurrentPensionsAmt = "What were your UK pensions worth on 5 April 2016?"

  val plaSummaryHiddenLinkTextCurrentPensionsAmt =
    "Change your response to the value of your UK pension savings on 5 April 2016"
  ...
  val plaSummaryHiddenLinkTextPensionDebits =
    "Change your response to the question 'Have any of your pensions been shared in a divorce since 5 April 2016?'"
  ...
  val plaSummaryConfirmation             = "I confirm that:"

  val plaSummaryConfirmBullet1 =
    "on 5 April 2016 I was a member of an HMRC-registered pension scheme or a relieved member of a relieved non-UK pension scheme"

  val plaSummaryConfirmBullet2 = "on 6 April 2016 I didn't hold either primary protection or individual protection 2014"
  val plaSummaryHelp           = "Help with these conditions"

  val plaSummaryHiddenParaOne =
    "Speak to your pension scheme administrator to get professional help understanding these conditions."

  val plaSummaryHiddenParaTwo =
    "HMRC's Pensions Tax Manual has technical guidance about individual protection 2016 (opens in new tab)."

  val plaSummaryHiddenParaLinkText = "technical guidance about individual protection 2016 (opens in new tab)"

  val plaSummaryConfirmation2 =
    "I confirm that the information I have provided is true and complete to the best of my knowledge and belief."

  val plaSummaryDeclaration =
    "By confirming, you will automatically submit your application for individual protection 2016."
