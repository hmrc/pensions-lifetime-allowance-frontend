...
trait AmendIP16PensionsUsedBetweenViewMessages {

  val plaPensionsUsedBetweenTitle =
    "How much lifetime allowance have you used? - Check your pension protections and enhancements - GOV.UK"

  val plaPensionsUsedBetweenHeader = "How much lifetime allowance have you used?"

  val plaPensionsUsedBetweenParaOne =
    "You'll have used some of your lifetime allowance if any of these events happened."
  ...
  val plaPensionsUsedBetweenStepOne =
    "Take the lifetime allowance at 5 April 2016 (£1.25m) and divide by the value of your lifetime allowance on the date the event happened."

  val plaPensionsUsedBetweenStepTwo =
    "Multiply the value of your lifetime allowance on the date the event happened by the percentage of lifetime allowance used."
