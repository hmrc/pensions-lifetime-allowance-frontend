...
class IP2016ControllerSpec
  ...
  object TestIP2016Controller
      extends IP2016Controller(
        mockSessionCacheService,
        mockMCC,
        mockAuthFunction,
        mockPensionsTaken,
    ...
    "applyFor2016IPAndFpShutterEnabled is disabled and not supplied with a stored model " should {
      "return 200" in new Setup {
        ...
        contentAsString(result) should include(
          "Before 6 April 2016, did you turn 75, take money from your pensions, or transfer to an overseas pension?"
        )
    ...
    "Submitting 'yes' in pensionsTakenBeforeForm" when {
      ...
      "valid data is submitted" should {
        "redirect to pensions worth before" in new Setup {
          ...
          object DataItem
              extends AuthorisedFakeRequestToPost(controller.submitPensionsTakenBefore, ("pensionsTakenBefore", "yes"))
      ...
      "invalid data is submitted" should {
        "return 400" in new Setup {
          ...
          object DataItem
              extends AuthorisedFakeRequestToPost(controller.submitPensionsTakenBefore, ("pensionsTakenBefore", ""))
    ...
    "Submitting 'no' in pensionsTakenBeforeForm" when {
      ...
      "valid data is submitted" should {
        "redirect to pensions taken between" in new Setup {
          ...
          object DataItem
              extends AuthorisedFakeRequestToPost(controller.submitPensionsTakenBefore, ("pensionsTakenBefore", "no"))
  ...
  "Submitting Pensions Worth Before data" when {
    ...
    "valid data is submitted" should {
      "redirect to pensions taken between" in new Setup {
        ...
        object DataItem
            extends AuthorisedFakeRequestToPost(controller.submitPensionsWorthBefore, ("pensionsWorthBeforeAmt", "1"))
    ...
    "no data is submitted" should {
      "return 400" in new Setup {
        ...
        object DataItem
            extends AuthorisedFakeRequestToPost(controller.submitPensionsWorthBefore, ("pensionsWorthBeforeAmt", ""))
      ...
      "return 400" in new Setup {
        ...
        object DataItem
            extends AuthorisedFakeRequestToPost(
              controller.submitPensionsWorthBefore,
              ("pensionsWorthBeforeAmt", "-100")
            )
    ...
    "Submitting 'yes' in pensionsTakenBetweenForm" when {
      ...
      "submitting valid data 'yes'" should {
        "redirect to pension used between" in new Setup {
          ...
          object DataItem
              extends AuthorisedFakeRequestToPost(
                controller.submitPensionsTakenBetween,
                ("pensionsTakenBetween", "yes")
              )
      ...
      "submitting valid data 'no'" should {
        "redirect to overseas pensions" in new Setup {
          ...
          object DataItem
              extends AuthorisedFakeRequestToPost(controller.submitPensionsTakenBetween, ("pensionsTakenBetween", "no"))
      ...
      "submitting invalid data" should {
        "return 400" in new Setup {
          ...
          object DataItem
              extends AuthorisedFakeRequestToPost(controller.submitPensionsTakenBetween, ("pensionsTakenBetween", ""))
    ...
    "Submitting valid in pensionsUsedBetweenForm" when {
      ...
      "submitting valid data" should {
        "redirect to overseas pensions" in new Setup {
          ...
          object DataItem
              extends AuthorisedFakeRequestToPost(controller.submitPensionsUsedBetween, ("pensionsUsedBetweenAmt", "1"))
      ...
      "submitting invalid data" should {
        "return 400" in new Setup {
          ...
          object DataItem
              extends AuthorisedFakeRequestToPost(controller.submitPensionsUsedBetween, ("pensionsTakenBetweenAmt", ""))
  ...
  "Submitting Overseas Pensions data" when {
    ...
    "Submitting valid data" should {
      "redirect to Current Pensions" in new Setup {
        ...
        object DataItem
            extends AuthorisedFakeRequestToPost(
              controller.submitOverseasPensions,
              ("overseasPensions", "no"),
              ("overseasPensionsAmt", "")
            )
  ...
  "Submitting Current Pensions data" when {
    ...
    "valid data is submitted" should {
      "redirect to Pension Debits page" in new Setup {
        ...
        object DataItem
            extends AuthorisedFakeRequestToPost(controller.submitCurrentPensions, ("currentPensionsAmt", "100000"))
    ...
    "invalid data is submitted" should {
      "return 400" in new Setup {
        ...
        object DataItem
            extends AuthorisedFakeRequestToPost(controller.submitCurrentPensions, ("currentPensionsAmt", ""))
