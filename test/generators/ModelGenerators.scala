...
import models.pla.response.{ProtectionRecord, ProtectionRecordsList, ProtectionStatus, ProtectionType, ReadProtectionsResponse}
...
trait ModelGenerators extends ScalaCheckDrivenPropertyChecks {
  ...
  val protectionRecordsListGen: Gen[ProtectionRecordsList] = for {
    ...
    ProtectionRecordsList(protectionRecord, historicaldetailsList)
  }
