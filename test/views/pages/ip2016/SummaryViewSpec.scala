...
class SummaryViewSpec extends CommonViewSpecHelper with SummaryViewMessages {
  ...
  def totalPensionsAmountSummaryRow(totalAmount: String) =
    SummaryRowModel("totalPensionsAmt", None, None, true, totalAmount)
  ...
  "the SummaryView" should {
    ...
    val positivePensionsTakenBeforeAmtSummaryRow = SummaryRowModel(
    ...
    val positivePensionsTakenSummaryRowTwo =
      SummaryRowModel("pensionsTaken", Some(controllers.routes.IP2016Controller.pensionsTaken), None, false, "No")
    val positiveOverseasPensionsSummaryRowTwo =
      SummaryRowModel("overseasPensions", Some(controllers.routes.IP2016Controller.overseasPensions), None, false, "No")
    val currentPensionsSummaryRowTwo = SummaryRowModel(
      "currentPensionsAmt",
      Some(controllers.routes.IP2016Controller.currentPensions),
      None,
      false,
    ...
    val positivePensionDebitsSummaryRowTwo =
    ...
    val model = SummaryModel(
      ...
      List(
        ...
        SummarySectionModel(List(positivePensionsTakenBeforeSummaryRow, positivePensionsTakenBeforeAmtSummaryRow)),
        SummarySectionModel(List(positivePensionsTakenBetweenSummaryRow, positivePensionsTakenBetweenAmtSummaryRow)),
    ...
    val modelTwo = SummaryModel(
      ApplicationType.IP2016,
      false,
      List(
        SummarySectionModel(List(positivePensionsTakenSummaryRowTwo)),
        SummarySectionModel(List(positiveOverseasPensionsSummaryRowTwo, positiveOverseasPensionsAmtSummaryRow)),
        SummarySectionModel(List(currentPensionsSummaryRowTwo)),
        SummarySectionModel(List(totalPensionsAmountSummaryRow("£123,456")))
      ),
      List(
        SummarySectionModel(List(positivePensionDebitsSummaryRowTwo)),
        SummarySectionModel(List(psoDetailsSummaryRow))
      )
    )
    ...
    "have a properly structured table" when {
      "looking at the value of pensions" in {
        ...
        doc
          ...
          .get(0)
          .text shouldBe s"$plaBaseChange $plaSummaryQuestionsPensionsTaken"
      }
