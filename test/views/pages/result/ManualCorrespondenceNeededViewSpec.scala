...
import testHelpers.messages.result.ManualCorrespondenceNeededMessages
...
class ManualCorrespondenceNeededViewSpec extends CommonViewSpecHelper with ManualCorrespondenceNeededMessages {
  ...
  "The Manual Correspondence needed page" should {
    ...
    "have the first heading which" should {
      ...
      val h1Tag = doc.select("h1.govuk-heading-xl")
    ...
    "have the the first paragraph which" should {
      ...
      val p1 = doc.select("div div p").get(0)
    ...
    "have the second heading which" should {
      ...
      val h2Tag0 = doc.select("div h2").get(0)
    ...
    "should contain a list of instructions which" should {
      ...
      val listOption = doc.select("#main-content > div > div > ol")
    ...
    "have the third heading which" should {
      ...
      val h2Tag1 = doc.select("h2").get(1)
    ...
    "should contain a list of other contact options which" should {
      ...
      val listOption = doc.select("#main-content > div > div > ul")
