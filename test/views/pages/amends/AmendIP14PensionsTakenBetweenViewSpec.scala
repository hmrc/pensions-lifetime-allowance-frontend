...
class AmendIP14PensionsTakenBetweenViewSpec extends CommonViewSpecHelper with AmendIP14PensionsTakenBetweenViewSpecMessages with PensionsUsedBetweenViewMessages {
  ...
  "the AmendIP14PensionsTakenBetweenView" should {
    ...
    val errorForm =  AmendPensionsTakenBetweenForm.amendPensionsTakenBetweenForm("ip2016").bind(Map.empty[String, String])
    ...
    "have the correct title" in{
      doc.title() shouldBe s"$plaIP14PensionsTakenBetweenTitle - Check your pension protections and enhancements - GOV.UK"
    }
