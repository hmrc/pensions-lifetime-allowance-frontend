...
class AmendIP14PensionsUsedBetweenViewSpec extends CommonViewSpecHelper with AmendIP14PensionsTakenBetweenViewSpecMessages with PensionsUsedBetweenViewMessages {
  ...
  "the AmendIP14PensionsUsedBetweenView" should {
    ...
    "have the correct title" in{
      doc.title() shouldBe s"$plaPensionsUsedBetweenHeader - Protect your lifetime allowance - GOV.UK"
    }
    ...
    "have the right explanatory paragraphs" in{
      ...
      doc.select("#ip14-amend-pensions-used-between-help p.govuk-body").eq(0).text shouldBe plaIP14PensionsTakenBetweenParaTwo
      doc.select("#ip14-amend-pensions-used-between-help p.govuk-body").eq(1).text shouldBe plaPensionsUsedBetweenParaThreeNew
    }
    ...
    "have a help link redirecting to the right location" in{
      ...
      doc.select("#ip14-amend-pensions-used-between-help a").attr("href") shouldBe plaPensionsUsedBetweenHelpLinkLocation
    }
